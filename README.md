...
![GitHub last commit](https://img.shields.io/github/last-commit/YourGitHubUsername/merobazar-backend?style=flat-square)  

The backend for **MeroBazar Ecommerce**, built with **Java Spring Boot**, **Spring Security**, and **MySQL/PostgreSQL**. This API handles user authentication, product management, order processing, and inventory tracking for an ecommerce platform.
...
JWT_EXPIRATION_MS= <expiration time in ms>
```
4. **Api EndPoints**

| Method | Endpoint                   | Description                    |
| ------ | -------------------------- | ------------------------------ |
| GET    | /api         | Register a new user            |
